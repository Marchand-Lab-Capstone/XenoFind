...
def setup_directory_system(working_directory):
    ...
    return [wdir, con_file_dir, p5dir, bcdir, forward_dir, fadir_fwd, reverse_dir, fadir_rev, total_dir, fadir_tot, vsearch_dir_fwd, vsearch_dir_rev, vsearch_dir_tot, xfconsdir, xfconsdir_fwd, xfconsdir_rev, xfconsdir_all, xna_find_dir]
