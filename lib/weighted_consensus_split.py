...
def consensus_generation(working_dir, raw_data, barcoded_fasta):
    ...
    directories_list = setup.setup_directory_system_con(working_dir)
    ...
    final_fasta_path = cs.merge_fasta_files(filtered_fasta_files, os.path.join(directories_list[1], 'consensus.fasta'))
