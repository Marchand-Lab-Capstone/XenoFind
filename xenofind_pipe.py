...
'''
# Consensus Paths
working_dir = '/home/marchandlab/github/jay/capstone/XenoFind/xenofind_test/240603_full_pipeline_GC_null_set/' #Input desired working/ file output directory here  <--- fix directory function to not neeed '/' at end
...
raw_dir = '/home/marchandlab/DataAnalysis/Kaplan/raw/pod5/240216_GC_71merPCR_xr_Train/20240216_1817_MN41475_ASE526_f9fc38c7/100_pod5'
...
placeholder_fasta = '/home/marchandlab/DataAnalysis/Kaplan/raw/pod5/240216_GC_71merPCR_xr_Train/reference/GC_71mer_xr_Train_fake_randomer.fasta'
...
consensus = False
model_gen = False #placeholder variables 
find = False
full = True
...
#Run both consensus formation and find 
if full == True:
    cmd = 'python xenofind.py full -w ' + working_dir+' -f '+ raw_dir+' -r '+placeholder_fasta
    os.system(cmd)
