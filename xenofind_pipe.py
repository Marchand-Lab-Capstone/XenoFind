...
'''
# Consensus Paths
working_dir = '/home/marchandlab/github/jay/capstone/XenoFind/xenofind_test/240411_PZ_xenomorph_library_test/' #Input desired working/ file output directory here  <--- fix directory function to not neeed '/' at end
