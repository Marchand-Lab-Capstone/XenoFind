...
'''
# Consensus Paths
working_dir = '/home/marchandlab/github/jay/capstone/XenoFind/xenofind_test/240410_PZ_139mer_test/' #Input desired working/ file output directory here  <--- fix directory function to not neeed '/' at end
...
placeholder_fasta = '/home/marchandlab/github/jay/capstone/reference/xPZ_NB25_xr_Train_fake_randomer.fasta'
