...
'''
# Consensus Paths
working_dir = '/media/sebastian/Slepnir/xenofind_datasets/Working_directory_PZ/' #Input desired working/ file output directory here  <--- fix directory function to not neeed '/' at end
...
working_dir_model = '/media/sebastian/Slepnir/xenofind_datasets/Working_directory_PZ/' #Input desired working/ file output directory here
raw_dir_train = '/media/sebastian/Slepnir/xenofind_datasets/PZ dataset/231117_PZn_libv4_minion/20231117_1644_MN37138_FAX70078_76df2751/' #Input either fast5 or pod5 containing directory here 
ref_fasta = '/media/sebastian/Slepnir/xenofind_datasets/PZ dataset/231117_PZn_libv4_minion/fasta_metadata/ref_libv2_PZ_CxDx.fa'
